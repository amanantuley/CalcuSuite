...
export default function PrintingCalculator() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 max-w-4xl mx-auto h-full">
      <div className="w-full md:w-1/2 flex flex-col">
        <Card className="flex-1 shadow-xl printable-area">
          <CardContent className="p-4 h-full flex flex-col">
            ...
            <ScrollArea className="flex-1 h-80 md:h-auto w-full bg-muted rounded-lg p-2 font-mono text-sm border shadow-inner">
              {history.map(entry => (
